...
import detectron.utils.visnew as vis_utils
...
def main(args):
    ...
    subprocess.call('ffmpeg -framerate 20 -i {}/file%02d.png -c:v libx264 -r 30 -pix_fmt yuv420p DensePoseData/infer_out/vid/out.mp4'
